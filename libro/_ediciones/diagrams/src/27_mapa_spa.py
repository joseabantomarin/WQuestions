"""Diagrama: mapa del dominio spa sobre los seis ejes de valor.
Cada eje es una banda horizontal con las entidades concretas del dominio.

Salida: ../png/27_mapa_spa.png
"""
...
AXES = [
    {"code": "Q", "name": "quién",  "fill": "#dbeafe", "edge": "#1d4ed8",
        "items": ["Ana", "Beto", "Carlos", "Anita (recep.)", "Spa Oasis"]},
    ...
    {"code": "L", "name": "dónde",  "fill": "#fef3c7", "edge": "#b45309",
        "items": ["spa_oasis_central", "cámara_vapor_1",
    ...
    {"code": "K", "name": "cuál",  "fill": "#e0e7ff", "edge": "#4f46e5",
        "items": ["servicio_spa", "finalizada", "real", "intencionado",
...
# Título
ax.text(7.5, 9.10, "El dominio spa mapeado a los 6 ejes de valor",
        ha="center", va="center", fontsize=14, fontweight="bold", color=INK)
ax.text(7.5, 8.70,
        "Cada eje aloja entidades de naturaleza homogénea. Los predicados del eje cómo (M) conectan unas con otras.",
...
# Pie
ax.text(7.5, 0.30,
        "Un dominio comercial pequeño cruza los 6 ejes de valor sin esfuerzo. Los predicados (eje cómo, M) son el cableado.",
