...
Estas cinco regularidades, juntas, son lo que hace que el núcleo de modelado de dominios sea tan corto (apenas 2.250 líneas) a pesar de cubrir territorios tan distintos como un spa, un banco regional, una historia clínica y un partido de fútbol. El motor no crece con cada dominio nuevo; el lexicon y los datos sí. La prueba más fuerte de esa propiedad llegó después, fuera de estos fragmentos: la aplicación meta-driven del Capítulo 26 —con menús, formularios y entidades enteras— se construyó sobre el mismo núcleo sin agregarle prácticamente código, porque también su estructura y su conducta son datos.
