# Capítulo 25 — WQuestions y los modelos de lenguaje
...
Lo que el capítulo 26 explora es el lado expansivo de esa misma idea: si WQuestions fuese infraestructura, **¿qué aplicaciones se vuelven posibles que antes no?**. Algunas suenan a ciencia ficción; otras son obvias en cuanto se nombran. Las dejaremos puestas, sin disimular la especulación, porque ahí — y solo ahí — es donde el libro se permite mirar hacia adelante.
