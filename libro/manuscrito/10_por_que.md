# Capítulo 10 — El "por qué" no es una pregunta más
...
Con este capítulo cerramos la Parte III, el corazón arquitectónico del libro: el hecho atómico, el espacio geométrico que forman al juntarse, las situaciones reificadas que amarran eventos complejos y los cables del "por qué" que le dan a la base de datos la capacidad de explicar sus propias acciones. La maquinaria conceptual está lista, armada y engrasada. 
