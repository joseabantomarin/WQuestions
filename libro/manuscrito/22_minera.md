...
Pero — y acá viene la fricción honesta — **el resultado "listo_para_operacion" no es un hecho atómico que el grafo guarde**. Es lógica derivada que se computa al vuelo, igual que el marcador del partido de fútbol (cap. 23) o el balance de una cuenta bancaria (cap. 18). El cap. 26 marca esta pieza — el motor de inferencia que evalúa reglas declarativas sobre el grafo y materializa resultados derivados — como el primer trabajo pendiente del proyecto.
