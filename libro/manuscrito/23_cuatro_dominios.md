# Capítulo 23 — Cuatro dominios incómodos: música, química, fútbol, contrato

## El test que vale la pena pasar

Hasta acá la Parte V modeló dominios que, por exigentes que fueran, seguían dentro de un esquema comercial, clínico o administrativo reconocible, donde el modelo funcionó con poca fricción.
...
**Las fricciones.** Dos quedaron registradas durante el modelado y persisten:
...
Con esto termina la Parte V. El modelo se sostuvo a lo largo de todos los dominios —con un prototipo Python de unas 2.250 líneas y un catálogo D8 de 38 roles canónicos—; las fricciones tienen patch o quedaron documentadas como pendientes.
