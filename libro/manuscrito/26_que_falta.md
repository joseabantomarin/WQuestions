# Capítulo 26 — Qué falta: validación, tooling, comunidad

## El contrato del cierre

Hasta acá el libro presentó la propuesta completa, validada por un prototipo en Python con tests pasando y por ocho dominios modelados que confirman que el catálogo se sostiene en territorios disímiles.
...
Además de los seis frentes mayores, hay un puñado de fricciones que el prototipo expuso y que siguen esperando trabajo. Las enumero en limpio para que queden listadas en un solo lugar:
