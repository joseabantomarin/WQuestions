# Capítulo 15 — Un servicio on-demand: el app de taxi
...
El capítulo anterior (el del Spa) fue como modelar un estanque tranquilo: el cliente llega al spa, se relaja y se va. Este capítulo nos lanza a los rápidos: aquí lidiaremos con la **pluralidad de agentes** (humanos y robots tomando decisiones a la vez), el **encadenamiento rápido de eventos** y la **causalidad emergente** (como cuando el precio del viaje sube de golpe porque hay lluvia o alta demanda). Veamos cómo nuestra arquitectura absorbe este caos sin inmutarse.
